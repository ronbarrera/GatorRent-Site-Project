...
class ListModel{
    ...
    public function create($info){
        ...
        $sql = "INSERT INTO Apartments (title, street_address, zipcode, price, rooms, description, picture_1) VALUES (:title, :street_address, :zipcode, :price, :rooms, :description, :picture_1)";        
