<div class="container">
    ...
    <p><strong>Last updated: December 1, 2016.</strong></p>
    <p>GatorRent.com knows that you care how information about you is used and shared, and we appreciate your trust that we will do so carefully and sensibly. This notice describes our privacy policy.<strong>By visiting GatorRent.com, you are accepting the practices described in this Privacy Notice.</strong></p>
    <br>
    <h2>What Personal Information About Customers Does GatorRent.com Gather?</h2>
    <br>
    ...
    <li><strong>Automatic Information: </strong>We receive and store certain types of information whenever you interact with us. For example, like many Web sites, we use "cookies," and we obtain certain types of information when your Web browser accesses Amazon.com or advertisements and other content served by or on behalf of Amazon.com on other Web sites.</li>
    <li><strong>E-mail Communications: </strong>To help us make e-mails more useful and interesting, we often receive a confirmation when you open e-mail from Amazon.com if your computer supports such capabilities. We also compare our customer list to lists received from other companies, in an effort to avoid sending unnecessary messages to our customers. If you do not want to receive e-mail or other mail from us, please adjust your Customer Communication Preferences .</li>
    <li><strong>Information from Other Sources: </strong>We might receive information about you from other sources and add it to our account information. Click here to see examples of the information we receive.</li>
    <br>
    <h2>Are Children Allowed to Use GatorRent.com?</h2>
    <p>GatorRent.com does not sell products for purchase by children. If you are under 18, you may use GatorRent.com only with the involvement of a parent or guardian.</p>
</div>